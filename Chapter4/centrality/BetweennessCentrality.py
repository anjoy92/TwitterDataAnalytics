...
# -*- coding: utf-8 -*-
"""
Calculate Betweenness Centrality from the file given
...
def main(args):
    ...
    parser = argparse.ArgumentParser(
        description='''Calculate Betweenness Centrality from the file given. ''',
    ...
    # Calculate the betweenness centrality from the tweet network
    betweenness_centrality = ttg.betweenness_centrality()
